...
#This produces a BAM file that includes the alignment information of the files and a VCF file that can be used for visualization
#Adjust parameters indels and maxMismatches for different datasets.
```
