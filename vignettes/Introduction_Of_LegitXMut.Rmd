...
# Specify paths, the sample data are stored in the inst/extdata/
...
mutateddemoalignment <- alignment_FASTQ(fastqPath, referencePath, indels = 10, maxMismatches = 1000, outputBAM = outputBAM)
...
#R studio can only read files under 5 mb, use wordpad/.text to view the result locally. Do not open it in R studio
```
